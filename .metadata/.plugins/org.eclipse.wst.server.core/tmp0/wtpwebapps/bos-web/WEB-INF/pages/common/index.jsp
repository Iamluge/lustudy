					...
					<table cellpadding=3>
						<tr>
							...
							<td><input required="required"
								...
								class="text01 easyui-validatebox" id="txtNewPass"
								type="Password" class="txt01" /></td>
						</tr>
						<tr>
							<td>确认密码：</td>
							<td><input required="required"
								data-options="validType:'length[4,8]'"
								class="text01 easyui-validatebox" id="txtRePass" type="Password"
								class="txt01" /></td>
						</tr>
					</table>
				</form>
