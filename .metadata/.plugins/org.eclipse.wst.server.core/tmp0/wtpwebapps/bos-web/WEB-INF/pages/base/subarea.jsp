...
<script type="text/javascript">
	...
	function dochart(){
		...
		//页面加载完成后，动态创建图表
		$.post('subareaAction_findSubareaByProvince.action',function(data){
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区饼状图" id="chartWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div id="test" border="false">
		</div></div>
</body>
</html>