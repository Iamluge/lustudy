...
<script type="text/javascript">
	...
	function doRestore() {
		...
		if (rows.length == 0) {
			...
			//没哟选中记录时，弹出提示
			$.messager.alert("提示信息", "请选择要还原的记录！", "warning");
		} else {
			//选中了取派员弹出确认框
			$.messager.confirm("提示信息", "确定要还原所选项吗？？", function(r) {
				if (r) {
					var array = new Array();
					//确定，发送请求
					//获取所选取派员的ID
					...
					var ids = array.join(",");
					location.href = "staffAction_recoverBatch.action?ids="
							+ ids;
				}
			});
			...
			<form id="addStaffForm" action="staffAction_add.action" method="post">
				...
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>手机</td>
						<td>
							<!-- 扩展手机号校验规则 --> <script type="text/javascript">
								$(function() {
