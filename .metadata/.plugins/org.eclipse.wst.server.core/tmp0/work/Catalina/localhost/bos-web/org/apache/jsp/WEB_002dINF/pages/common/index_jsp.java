 ...
 * Generated at: 2017-09-28 12:50:31 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t// 基本功能菜单加载\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\turl : 'functionAction_findMenu.action',\r\n");
      out.write("\t\t\ttype : 'POST',\r\n");
      ...
      out.write("\t\t\t//进行表单校验\r\n");
      out.write("\t\t\tvar bool = $(\"#editPasswordForm\").form(\"validate\");\r\n");
      out.write("\t\t\tif (bool) {\r\n");
      out.write("\t\t\t\t//表示表单校验通过,手动校验两次输入是否一致\r\n");
      out.write("\t\t\t\tvar v1 = $(\"#txtNewPass\").val();\r\n");
      out.write("\t\t\t\tvar v2 = $(\"#txtRePass\").val();\r\n");
      out.write("\t\t\t\tif (v1 == v2) {\r\n");
      out.write("\t\t\t\t\t//两次输入一致\r\n");
      out.write("\t\t\t\t\t$.post(\"userAction_editPassword.action\", {\r\n");
      out.write("\t\t\t\t\t\t\"password\" : v1\r\n");
      out.write("\t\t\t\t\t}, function(data) {\r\n");
      out.write("\t\t\t\t\t\t//0代表失败、1、代表成功\r\n");
      out.write("\t\t\t\t\t\tif (data == '1') {\r\n");
      out.write("$(\"#editPwdWindow\").window(\"close\");\r\n");
      out.write("\t\t\t\t\t\t} else {\r\n");
      ...
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>新密码：</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input required=\"required\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"validType:'length[4,8]'\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"text01 easyui-validatebox\" id=\"txtNewPass\"\r\n");
      out.write("\t\t\t\t\t\t\t\ttype=\"Password\" class=\"txt01\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td>确认密码：</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input required=\"required\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"validType:'length[4,8]'\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"text01 easyui-validatebox\" id=\"txtRePass\" type=\"Password\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"txt01\" /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t</div>\r\n");
