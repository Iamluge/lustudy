 ...
 * 
 */
@WebServiceClient(name = "WebserviceServerService", targetNamespace = "http://service.lu.com/", wsdlLocation = "http://192.168.240.1:8080/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESERVERSERVICE_QNAME = new QName("http://service.lu.com/", "WebserviceServerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.240.1:8080/hello?wsdl");
    ...
    public WebserviceServer getWebserviceServerPort() {
        return super.getPort(new QName("http://service.lu.com/", "WebserviceServerPort"), WebserviceServer.class);
    }
    ...
    public WebserviceServer getWebserviceServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.lu.com/", "WebserviceServerPort"), WebserviceServer.class, features);
    }
